# ============================================================
# MobileNetV2 + Mish + CrossEntropy Comparative Study (PyTorch)
...
if __name__ == '__main__':
    ...
    plt.title('Training and Validation Loss Comparison (mish)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Training and Validation Accuracy Comparison (mish)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Final Core Evaluation Benchmarks (mish Model)', fontsize=13, fontweight='bold', pad=15)
