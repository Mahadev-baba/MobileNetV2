# ============================================================
# MobileNetV2 +LeakyReLU + CrossEntropy Comparative Study (PyTorch)
...
if __name__ == '__main__':
    ...
    plt.title('Training and Validation Loss Comparison (LeakyReLU)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Training and Validation Accuracy Comparison (LeakyReLU)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Final Core Evaluation Benchmarks (ELU Model)', fontsize=13, fontweight='bold', pad=15)
