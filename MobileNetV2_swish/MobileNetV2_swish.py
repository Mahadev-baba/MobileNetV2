# ============================================================
# MobileNetV2 + swish + CrossEntropy Comparative Study (PyTorch)
...
if __name__ == '__main__':
    ...
    plt.title('Training and Validation Loss Comparison (swish)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Training and Validation Accuracy Comparison (swish)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Final Core Evaluation Benchmarks (swish Model)', fontsize=13, fontweight='bold', pad=15)
