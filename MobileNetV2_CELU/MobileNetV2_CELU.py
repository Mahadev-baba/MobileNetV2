# ============================================================
# MobileNetV2 +CELU+ CrossEntropy Comparative Study (PyTorch)
...
if __name__ == '__main__':
    ...
    plt.title('Training and Validation Loss Comparison (CELU)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Training and Validation Accuracy Comparison (CELU)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.bar(x_idx - width/2, filtered_comp['140K'], width, label='140K Dataset (CELU)', color='royalblue')
    plt.bar(x_idx + width/2, filtered_comp['200K'], width, label='200K Dataset (CELU)', color='darkorange')

    plt.title('Final Core Evaluation Benchmarks (CELU Model)', fontsize=13, fontweight='bold', pad=15)
