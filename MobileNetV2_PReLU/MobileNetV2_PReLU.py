# ============================================================
# MobileNetV2 +PReLU+ CrossEntropy Comparative Study (PyTorch)
...
if __name__ == '__main__':
    ...
    plt.title('Training and Validation Loss Comparison (PReLU)', fontsize=13, fontweight='bold')
    plt.xlabel('Epochs')
    ...
    plt.title('Final Core Evaluation Benchmarks (PReLU Model)', fontsize=13, fontweight='bold', pad=15)
